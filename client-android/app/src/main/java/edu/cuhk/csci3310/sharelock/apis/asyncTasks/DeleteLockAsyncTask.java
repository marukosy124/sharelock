...
public class DeleteLockAsyncTask extends AsyncTask<String, String, String> {
    ...
    public DeleteLockAsyncTask(OnLockTaskCompleted listener, Activity activity, Bundle lockData){
    ...
    protected void onPostExecute(String response) {
        listener.onLockTaskCompleted(null);
