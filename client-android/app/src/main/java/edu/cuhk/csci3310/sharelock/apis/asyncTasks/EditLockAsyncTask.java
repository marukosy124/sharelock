...
public class EditLockAsyncTask extends AsyncTask<String, String, String> {
    private static final String TAG = "EditLockAsyncTask";
    ...
    public EditLockAsyncTask(OnLockTaskCompleted listener, Activity activity, Bundle lockData){
    ...
    public String editLock () {
        try {
            ...
            RequestBody body;
            if(lockData.getString(LOCK_PRIVATE_KEY) == null){
                body = new MultipartBody.Builder().setType(MultipartBody.FORM)
                        .addFormDataPart(LOCK_NAME, lockData.getString(LOCK_NAME)).build();
            } else {
                body = new MultipartBody.Builder().setType(MultipartBody.FORM)
            ...
            Request request = new Request.Builder()
                    .url(BASE_URL + "/locks/" + lockData.getInt(LOCK_ID))
                    .method("PUT", body)
