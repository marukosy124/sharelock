...
public class EditLockAccessAsyncTask extends AsyncTask<String, String, String> {
    private static final String TAG = "EditLockAccessAsyncTask";
    ...
    public EditLockAccessAsyncTask(OnLockAccessTaskCompleted listener, Activity activity, Bundle lockAccessData){
